...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_length_sentence", type=int, default=1024, help="Max length of sentence")
    parser.add_argument("--train_batch_size", type=int, default=8, help="Training batch size")
    parser.add_argument("--validation_batch_size", type=int, default=4, help="Validation batch size")
    parser.add_argument("--learning_rate", type=float, default=1e-4, help="Learning rate")
    parser.add_argument("--data_set", type=str, default='pretrain_all', help="Dataset name")
    parser.add_argument("--comment", type=str, default='pretrain_translation_pair_span_corruption_test', help="Comment for the current run")
    parser.add_argument("--patience", type=int, default=3, help="Patience for early stopping")
    parser.add_argument("--task", type=str, default='translation_pair_span_corruption', help="Specific task for pretraining")
