...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_tokenizer_path", type=str, default='Transformers-PALGA/flan_tokenizer', help="Local tokenizer path")
    parser.add_argument("--local_model_path", type=str, default='Transformers-PALGA/models/flan-t5-small', help="Local model path")
