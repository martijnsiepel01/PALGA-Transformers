...
def generate_config_and_run_name(num_train_epochs, max_length_sentence, train_batch_size, validation_batch_size, learning_rate, max_generate_length, update_tokenizer, data_set):
    config = {
...
def setup_model(tokenizer, local_model_path = '/home/msiepel/mT5'):
